...
const CreateShop = ({sellerId,
  setActiveStep}:{sellerId: string;
...
shopCreateMutation.mutate(shopData);
  ...
  return (
    <div><form onSubmit={handleSubmit(onsubmit)}>
      ...
      <label className="bllock text-gray-700 mb-1">Name *</label>
      <input type="text"
...
<label className="block text-gray-700 mb-1">Address *</label>
       ...
       <label className="block text-gray-700 mb-1">Opening Hours *</label>
        ...
        <select className='w-full p-2 border border-gray-300 outline-0 rounded-[4px] mn-1'
        {...register("category",{required:"Catgeory is required"})}
        >
